...
public interface XMLDialect {
    ...
    static final Integer CONSTRAINT_DOCTYPE = CONSTRAINT_DOCTYPE_UNBOXED;
    /** Constraint on PUBLIC Doctype declaration. */
    static final Integer CONSTRAINT_PUBLIC_DOCTYPE = CONSTRAINT_PUBLIC_DOCTYPE_UNBOXED;
    /** Constraint on SYSTEM Doctype declaration. */
    static final Integer CONSTRAINT_SYSTEM_DOCTYPE = CONSTRAINT_SYSTEM_DOCTYPE_UNBOXED;
    /** Constraint on root tag name. */
    static final Integer CONSTRAINT_ROOT = CONSTRAINT_ROOT_UNBOXED;
    /** Constraint on xmlns declaration. */
    static final Integer CONSTRAINT_XMLNS = CONSTRAINT_XMLNS_UNBOXED;
