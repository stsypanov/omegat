...
//    }
    ...
    public static boolean isFocusAncestor(@NotNull final JComponent component) {
        ...
        return owner != null && (owner == component || SwingUtilities.isDescendingFrom(owner, component));
    }
    ...
    public static boolean isCloseClick(MouseEvent e, int effectiveType) {
        return !(e.isPopupTrigger() || e.getID() != effectiveType) && (e.getButton() == MouseEvent.BUTTON2 || e.getButton() == MouseEvent.BUTTON1 && e.isShiftDown());
    }
    ...
    public static boolean isActionClick(MouseEvent e, int effectiveType, boolean allowShift) {
        return !(!allowShift && isCloseClick(e) || e.isPopupTrigger() || e.getID() != effectiveType) && e.getButton() == MouseEvent.BUTTON1;
    }
...
//    }
//
//    public static <T extends JComponent> java.util.List<T> findComponentsOfType(JComponent parent, Class<T> cls) {
...
//        private final java.util.List<Pair<String, LineInfo>> myLines = new ArrayList<Pair<String, LineInfo>>();
...
//        java.util.List<String> GENERIC = Arrays.asList(Font.DIALOG, Font.DIALOG_INPUT, Font.MONOSPACED, Font.SANS_SERIF, Font.SERIF);
//        int patternSize = 50;
...
//        javax.swing.plaf.ButtonUI ui = alignSource.getUI();
